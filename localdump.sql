...
--
-- Host: localhost    Database: rtc55314
-- ------------------------------------------------------
...
CREATE TABLE `courses` (
  ...
  `course_desc` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `forum_categories` (
  ...
  `marked_entity_id` int(11) NOT NULL,
  `name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `viewable_to` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `forum_topics` VALUES (1,'Due date is moved',1,'2022-03-27 14:04:14',1),(2,'another test',2,'2022-03-27 14:39:58',1),(3,'helllllllllllllll',2,'2022-03-27 14:42:18',1),(4,'againnnn',3,'2022-03-27 14:44:25',1),(5,'Working?',3,'2022-03-27 15:16:59',1),(6,'Redirecting?',3,'2022-03-27 15:17:59',1),(7,'What do we do now?',1,'2022-03-31 23:31:07',1),(8,'Question about assignment 2',2,'2022-04-01 20:01:30',1),(9,'hey all',1,'2022-04-01 20:03:57',1),(10,'first post for assignment 3',14,'2022-04-01 20:05:06',1),(11,'hello public',4,'2022-04-01 22:23:20',1),(12,'Lets discuss group 1',29,'2022-04-02 00:16:40',1),(13,'WHY?????',34,'2022-04-02 00:17:01',1),(14,'Assignment details are in the paper',41,'2022-04-02 17:56:00',1);
...
INSERT INTO `group_users` VALUES (1,2,'0000-00-00 00:00:00',NULL),(1,3,'0000-00-00 00:00:00',NULL),(2,1,'0000-00-00 00:00:00',NULL),(3,1,'0000-00-00 00:00:00',NULL),(4,1,'0000-00-00 00:00:00',NULL),(6,4,'0000-00-00 00:00:00',NULL);
...
INSERT INTO `groups` VALUES (1,1,'Group 1',4,1),(2,1,'Group 2',4,1),(3,3,'Group 1',4,1),(4,3,'Group 2',4,1),(5,1,'Group 3',4,1),(6,1,'Group 4',4,1),(7,1,'Group 5',4,1);
...
CREATE TABLE `marked_entities` (
  `marked_entity_id` int(10) unsigned NOT NULL,
  `section_id` int(11) NOT NULL,
  `name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `post_date` date NOT NULL,
  `due_date` date NOT NULL,
  `type` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `work_type` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `viewable_to` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `permissions` (
  ...
  `permission_type` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `sections` (
  ...
  `section_name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `user_roles` VALUES (1,1),(1,2),(1,3),(1,4),(2,3),(2,4),(3,2),(3,3),(3,4),(4,4);
...
INSERT INTO `users_sections` VALUES (1,1),(1,2),(1,3),(2,1),(3,1),(3,2),(4,1);
...
-- Dump completed on 2022-04-03  1:52:08
