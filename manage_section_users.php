...
$result = mysqli_query($link,"SELECT user_id,username from users where user_id IN(SELECT user_id FROM users_roles_sections WHERE section_id = '$id' AND role_id=4)");
