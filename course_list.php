...
<hr>
	...
	$data = $link->query("SELECT * FROM courses c JOIN sections s ON c.course_id = s.course_id JOIN users_sections us ON s.section_id = us.section_id WHERE us.user_id = " . $_SESSION['id']);
	if($data -> num_rows>0){
