    ...
    <tr>
	 ...
	 <th>Options</th>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='edit_section.php?id=" . $row['section_id'] . "'>Edit</a>/<a href='delete_section.php?id=" . $row['section_id'] . "'>Delete</a>/<a href='manage_groups.php?id=" . $row['section_id'] . "'>Groups</a>/<a href='manage_section_users.php?id=" . $row['section_id'] . "'>Manage Students</a>/<a href='manage_section_tas.php?id=" . $row['section_id'] . "'>Manage TAs</a></td>";
            echo "</tr>";
        }
        echo "</table>";
    }
